package com.example.basicpay.ui.login;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void checkLogin(EditText usernameEditText, EditText passwordEditText) {
        l.log(Level.INFO, passwordEditText.getText().toString());
        l.log(Level.INFO, usernameEditText.getText().toString());
        l.log(Level.INFO, loggers.getPassWord());
        l.log(Level.INFO, loggers.getUserId());
